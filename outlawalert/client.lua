...
--- Phone Trigger for GPS
RegisterNetEvent('notifyoa')
AddEventHandler('notifyoa', function()
   ...
   if crossing ~= nil then
     ...
     TriggerServerEvent('esx_phone:send', "police", "Unit respond to " .. streetName .. " and " .. crossing, true, {
       x = coords.x,
       y = coords.y,
       z = coords.z
     })
   else
     TriggerServerEvent('esx_phone:send', "police", "Unit respond to " .. streetName, true, {
       x = coords.x,
       y = coords.y,
       z = coords.z
     })
