Locales['en'] = {
  ...
  ['associate_wear'] = 'Associate Suit',
  ['soldier_wear'] = 'Soldier Suit',
  ['lieutenant_wear'] = 'Lieutenant Suit',
  ['boss_wear'] = 'Drug Lord Suit',
  ['cartel_wear'] = 'Signature Cartel Suit',
  ['field_wear'] = 'Field Work Clothes',
  ...
  ['phone_police'] = 'police',
  ['distress_sent'] = 'Distress signal has been sent to all available units!',
