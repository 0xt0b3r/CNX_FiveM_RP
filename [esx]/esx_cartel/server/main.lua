...
AddEventHandler('esx_cartel:giveWeapon', function(weapon, ammo)
	...
	if xPlayer.job.name == 'cartel' then
		...
		print(('esx_cartel: %s attempted to give weapon!'):format(xPlayer.identifier))
	end
end)
...
--		print(('esx_cartel: %s attempted to confiscate!'):format(xPlayer.identifier))
--		return
--	end
--
...
--	else
--		print(('esx_cartel: %s attempted to handcuff a player (not cop)!'):format(xPlayer.identifier))
--	end
--end)
...
--
--	if xPlayer.job.name == 'cartel' then
--		TriggerClientEvent('esx_cartel:drag', target, source)
--	else
--		print(('esx_cartel: %s attempted to drag (not cop)!'):format(xPlayer.identifier))
--	end
--end)
...
--	else
--		print(('esx_cartel: %s attempted to put in vehicle (not cop)!'):format(xPlayer.identifier))
--	end
--end)
...
--	else
--		print(('esx_cartel: %s attempted to drag out from vehicle (not cop)!'):format(xPlayer.identifier))
--	end
--end)
...
-- ESX.RegisterServerCallback('esx_cartel:getVehicleFromPlate', function(source, cb, plate)
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		if xPlayer ~= nil and xPlayer.job ~= nil and xPlayer.job.name == 'cartel' then
			Citizen.Wait(5000)
			TriggerClientEvent('esx_cartel:updateBlip', -1)
		end
	end	
end)

RegisterServerEvent('esx_cartel:spawned')
AddEventHandler('esx_cartel:spawned', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_cartel:forceBlip')
AddEventHandler('esx_cartel:forceBlip', function()
	TriggerClientEvent('esx_cartel:updateBlip', -1)
end)
...
-- RegisterServerEvent('esx_cartel:message')
-- AddEventHandler('esx_cartel:message', function(target, msg)
