...
Config.Zones = {
	...
	MecanoActions = {
		Pos   = { x = -224.50, y = -1320.54, z = 29.89 },
	...
	Garage = {
		Pos   = { x = -227.28, y = -1327.95, z = 29.89 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	Craft = {
		Pos   = { x = -201.05, y = -1317.95, z = 30.09 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -211.73, y = -1305.97, z = 30.35 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -197.38, y = -1305.97, z = 30.35 },
	...
	VehicleDelivery = {
		Pos   = { x = -207.56, y = -1302.82, z = 30.30 },
