...
function DemarchesMenu()
    ped = GetPlayerPed(-1);
	options.menu_subtitle = _U('categories')
    ClearMenu()	
	Menu.addButton(_U('humeurs'), "demHumeurs", nil)
	Menu.addButton(_U('attitudes'), "demAttitudes", nil)
    Menu.addButton(_U('autres'), "demAutres", nil)
	Menu.addButton(_U('femmes'), "demFemmes", nil)
    Menu.addButton("~c~---------------------------", "quitter", nil)
    Menu.addButton(_U('quitter'), "quitter", nil)
end
...
function demHumeurs()
    ...
    ClearMenu()
							Menu.addButton(_U('determine'), 	"humeurs1",nil)
							Menu.addButton(_U('triste'),      	"humeurs2",nil)
							Menu.addButton(_U('depression'), 	"humeurs4",nil)
							Menu.addButton(_U('enerve'),  		"humeurs5",nil)
							Menu.addButton(_U('presse'),		"humeurs6",nil)
							Menu.addButton(_U('timide'), 		"humeurs9",nil)
							Menu.addButton(_U('lunatique'),  	"humeurs10",nil)
							Menu.addButton(_U('stresse'),  		"humeurs11",nil)
							Menu.addButton(_U('flemme'),    	"humeurs12",nil)

							Menu.addButton("~c~---------------------------", "DemarchesMenu", nil)
							Menu.addButton(_U('reset'), "reset", nil)
end
...
function demAttitudes()
    ...
    ClearMenu()
					Menu.addButton(_U('hautain'),    						"attitude1",nil)
					Menu.addButton(_U('badboy'),             				"attitude2",nil)
					Menu.addButton(_U('gangster'),							"attitude3",nil)
					Menu.addButton(_U('fraquasse'),							"attitude4",nil)
					Menu.addButton(_U('coquille'),    						"attitude5",nil)
					Menu.addButton(_U('coince'),             				"attitude6",nil)
					Menu.addButton(_U('perdu'),             				"attitude9",nil)
					Menu.addButton(_U('intimidant'),						"attitude10",nil)
					Menu.addButton(_U('richissime'),    					"attitude11",nil)
					Menu.addButton(_U('hargneux'),							"attitude12",nil)
					Menu.addButton(_U('imposant'),							"attitude13",nil)
					Menu.addButton(_U('frimeur'),							"attitude14",nil)
...
function demAutres()
    ...
    ClearMenu()
					Menu.addButton(_U('randonneur'),				"autres1",nil)
					Menu.addButton(_U('blesse'),    			"autres2",nil)
					Menu.addButton(_U('obese'),				"autres3",nil)
					Menu.addButton(_U('fesses'), 				"autres4",nil)
					Menu.addButton(_U('detente'),				"autres6",nil)
    ...
    ClearMenu()
					Menu.addButton(_U('arrogante'),    						"femmes1",nil)
					Menu.addButton(_U('classique'),							"femmes3",nil)
					Menu.addButton(_U('fragile'),             			"femmes5",nil)
					Menu.addButton(_U('enerve'),							"femmes6",nil)
					Menu.addButton(_U('fatale'),             				"femmes8",nil)
					Menu.addButton(_U('fuite'),    							"femmes10",nil)
					Menu.addButton(_U('tristesse'),             			"femmes11",nil)
					Menu.addButton(_U('rebelle'),							"femmes12",nil)
					Menu.addButton(_U('serieuse'),    							"femmes13",nil)
					Menu.addButton(_U('ffesses'),             				"femmes14",nil)
					Menu.addButton(_U('hautaines'),							"femmes15",nil)
					Menu.addButton("~c~---------------------------", "DemarchesMenu", nil)
					Menu.addButton(_U('reset'),							"reset", nil)
