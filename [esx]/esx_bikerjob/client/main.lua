...
function OpenCloakroomMenu()
	...
	if grade == 'associate' then
		table.insert(elements, {label = _U('prospect_wear'), value = 'prospect_wear'})
	elseif grade == 'soldier' then
		table.insert(elements, {label = _U('member_wear'), value = 'member_wear'})
	elseif grade == 'lieutenant' then
		table.insert(elements, {label = _U('enforcer_wear'), value = 'enforcer_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if data.current.value == 'citizen_wear' then
			...
			-- 			TriggerEvent('esx_biker:updateBlip')
		...
		if
			...
			data.current.value == 'member_wear' or
...
-- 						TriggerServerEvent('esx_biker:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
-- 						OpenBodySearchMenu(closestPlayer)
-- 					elseif action == 'handcuff' then
-- 						TriggerServerEvent('esx_biker:handcuff', GetPlayerServerId(closestPlayer))
-- 					elseif action == 'drag' then
-- 						TriggerServerEvent('esx_biker:drag', GetPlayerServerId(closestPlayer))
-- 					elseif action == 'put_in_vehicle' then
-- 						TriggerServerEvent('esx_biker:putInVehicle', GetPlayerServerId(closestPlayer))
-- 					elseif action == 'out_the_vehicle' then
-- 						TriggerServerEvent('esx_biker:OutVehicle', GetPlayerServerId(closestPlayer))
...
-- 				TriggerServerEvent('esx_biker:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
-- 	ESX.TriggerServerCallback('esx_biker:getFineList', function(fines)
...
function LookupVehicle()
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'lookup_vehicle',
	{
		...
		if data.value == nil or length < 2 or length > 13 then
			...
			ESX.TriggerServerCallback('esx_biker:getVehicleFromPlate', function(owner, found)
				if found then
...
-- 			TriggerServerEvent('esx_biker:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
-- 	ESX.TriggerServerCallback('esx_biker:getVehicleInfos', function(retrivedInfo)
...
AddEventHandler('esx:setJob', function(job)
	...
	Citizen.Wait(5000)
	TriggerServerEvent('esx_biker:forceBlip')
end)
...
-- AddEventHandler('esx_biker:hasEnteredEntityZone', function(entity)
-- 	local playerPed = PlayerPedId()
...
AddEventHandler('esx_biker:hasExitedEntityZone', function(entity)
...
-- RegisterNetEvent('esx_biker:unrestrain')
-- AddEventHandler('esx_biker:unrestrain', function()
-- 	if IsHandcuffed then
-- 		local playerPed = PlayerPedId()
-- 		IsHandcuffed = false
...
-- AddEventHandler('esx_biker:drag', function(copID)
...
-- AddEventHandler('esx_biker:OutVehicle', function()
-- 	local playerPed = PlayerPedId()
...
-- 				TriggerEvent('esx_biker:hasEnteredEntityZone', closestEntity)
-- 				LastEntity = closestEntity
-- 			end
-- 		else
-- 			if LastEntity ~= nil then
-- 				TriggerEvent('esx_biker:hasExitedEntityZone', LastEntity)
-- 				LastEntity = nil
-- 			end
-- 		end
-- 	end
...
Citizen.CreateThread(function()
	while true do
		...
		-- 	CurrentTask.Busy = false
		-- end
		-- if IsControlJustPressed(0, Keys['F10']) and GetLastInputMethod(2) and PlayerData.job ~= nil and PlayerData.job.name == 'biker' then
		-- 	SendbikerDistressSignal()
		-- end
	end
end)
...
-- 	end
-- end
-- function SendbikerDistressSignal()
-- 	local playerPed = GetPlayerPed(-1)
-- 	local coords	= GetEntityCoords(playerPed)

-- 	ESX.ShowNotification(_U('distress_sent'))
-- 	TriggerServerEvent('esx_phone:send', 'biker', _U('biker_distress_message'), false, {
-- 		x = coords.x,
-- 		y = coords.y,
-- 		z = coords.z
-- 	})
...
-- RegisterNetEvent('esx_biker:updateBlip')
-- AddEventHandler('esx_biker:updateBlip', function()
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('esx_biker:unrestrain')
	
	if not hasAlreadyJoined then
		TriggerServerEvent('esx_biker:spawned')
	end
